...
mkdir project
cd project
cmake -DBUILD64=OFF -C "$rootdir/CMakeLists.txt" -DCMAKE_INSTALL_PREFIX="$rootdir/$target" -DZLIB_INCLUDE_DIR="$rootdir/../../include/$target" -DZLIB_LIBRARY="$rootdir/../../lib/$target/libz.a" ..
cmake -DBUILD64=OFF -C "$rootdir/CMakeLists.txt" -DCMAKE_INSTALL_PREFIX="$rootdir/$target" -DZLIB_INCLUDE_DIR="$rootdir/../../include/$target" -DZLIB_LIBRARY="$rootdir/../../lib/$target/libz.a" ..
